...
pub use management::{
    ...
    DesktopEntityMutationReceipt, DesktopExecutionKind, DesktopGithubCredential, DesktopHostEdit,
    DesktopManagedLogin, DesktopManagementSnapshot, DesktopMemoryMutation, DesktopMemorySnapshot,
    ...
    DesktopProfileRetirement, DesktopProfileSummary, DesktopProjectDraft, DesktopProjectSummary,
    DesktopProviderKind, DesktopResetPlan, DesktopResetReceipt, DesktopResetScope,
    DesktopResetTarget, DesktopResourceLimit, DesktopResourcePolicyDraft,
    DesktopResourcePolicyPreview, DesktopResourcePolicySnapshot, DesktopScheduleEdit,
    DesktopScheduledTask, DesktopSecret, DesktopSetupDraft, DesktopSetupMode, DesktopSetupReceipt,
    DesktopSetupSnapshot, DesktopTaskDraft, DesktopTaskPreview, DesktopTaskTrigger,
    DesktopUsagePage, DesktopWorkGroup, DesktopWorkbenchPreferenceSnapshot,
    DesktopWorkerCancellation, DesktopWorkerIntent, DesktopWorkerSummary, MemoryClaim,
    MemoryControlEdit, MemoryControls, MemoryEdit, MemoryPage, MemoryRecord, MemoryScope,
    MemoryState, SourceDeletionPreview, SourceDeletionReceipt,
};
pub use management::{
