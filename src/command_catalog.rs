...
pub(crate) const COMMANDS: &[CommandSpec] = &[
    ...
    command!(
        ...
        "browser",
        &[],
        "status|takeover|close|resolve RECEIPT REVISION applied|not-applied",
        "Inspect, revoke or explicitly reconcile an uncertain browser effect; never replay it",
        ArgumentSchema::Variants("status|takeover|close|resolve"),
        Controller,
        Interactive,
        None,
        Control,
