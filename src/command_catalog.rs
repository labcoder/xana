...
pub(crate) const COMMANDS: &[CommandSpec] = &[
    ...
    command!(
        ...
        "attach",
        &[],
        "WORKSPACE_RELATIVE_PATH|--clipboard",
        "Stage a path or explicit clipboard image for the next turn",
    ...
    command!(
        ...
        "setup",
        &[],
        "[quick|full|connection|permissions-shell|profiles-routes|appearance]",
